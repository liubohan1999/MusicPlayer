        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.img_play_type:
                    ...
                    switch (type){
                        case 0:
                            imgPlayType.setImageDrawable(getResources().getDrawable(R.drawable.xunhuan));//循环播放
                            break;
                        case 1:
                            imgPlayType.setImageDrawable(getResources().getDrawable(R.drawable.danqu)); //单曲循环
                            break;
                        case 2:
                            imgPlayType.setImageDrawable(getResources().getDrawable(R.drawable.suiji)); //随机播放
                            break;
                        default:
                            break;
                    }
            ...
            musicService.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    switch (type){
                        ...
                        case 2:
                            mTimer.cancel();
                            index = random.nextInt(musicList.size());  //一个随机数函数，参数是音乐列表的长度
                            playPerpare();
                            break;
                        default:
                            break;
